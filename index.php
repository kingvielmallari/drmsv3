...
<div class="container py-5">
  <div class="row justify-content-center align-items-center my-5 g-5">
    <!-- Carousel Section -->

    <div class="col-md-6 mt-5">
      <h2 class="text-center mb-4">Welcome <span class="text-success"><strong>PTC</strong></span>ians!</h2>
      <p class="text-center">Please enter your <strong>DRMS</strong> account.</p>
      ...
      <p class="text-center mt-3">
        No DRMS account? <a href="add.php">Create an Account</a>
      </p>
    </div>
    <div class="col-md-6">
      <div id="carouselExampleIndicators" class="carousel slide" style="max-width: 100%;">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="images/logo2.jpg" class="d-block w-100" alt="..." style="height: 400px; object-fit: cover;">
          </div>
        </div>
